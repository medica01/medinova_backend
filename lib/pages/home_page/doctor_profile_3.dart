...
class _doc_profileState extends State<doc_profile> {
  ...
  void initState() {
    super.initState();
    pk = widget.data.toString(); // Ensure pk is a string
    _showdoctor2();
  }

  Future<void> _showdoctor2() async {
    ...
    final url = Uri.parse("http://$ip:8000/doctor_details/doctor_editdetails/$pk/");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Doctor's Profile")),
      body: isLoading
            ...
            children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("${doctor.service ?? 0} years of experience"),
                            Text(doctor.language ?? "Tamil"),
                            Text(doctor.doctorLocation ?? "Chennai"),
                          ],
                        ),
              ...
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("About Doctor", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
              ...
              Padding(
                padding: const EdgeInsets.all(15.0),
                child: Text("Treatment and Procedures", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
              ),
              Padding(
                padding: const EdgeInsets.all(15.0),
                child: Text(doctor.specialty ?? "No treatment information"),
              ),
              SizedBox(height: 200),
            ],
          )
