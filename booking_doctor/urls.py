...
urlpatterns=[
    ...
    path("get_specific_fav_doc/<int:phone_number>/<int:doctor_id>/",get_specific_fav_doc.as_view(),name="get_specific_fav_doc"),
    path("delete_fav_doc/<int:phone_number>/<int:doctor_id>/",delete_fav_doc.as_view(),name="delete_fav_doc"),
    path("create_chat_doc_only_user_chat/",create_chat_doc_only_user_chat.as_view(),name="create_chat_doc_only_user_chat"),
    path("create_booked_doc_chat/",create_booked_doc_chat.as_view(),name="create_booked_doc_chat"),
    ...
    path("get_show_booked_doc_chat/<int:patient_phone_number>/",get_show_booked_doc_chat.as_view(),name="get_show_booked_doc_chat"),
